...
parser.add_argument('--dataset_path', type=str, default='train_frame', help='directory of data')
parser.add_argument('--checkpoint_path', type=str, default='check', help='save checkpoints')
...
train_folder = args.dataset_path+"\\"+"training\\frames"
# train_folder = args.dataset_path
print(train_folder)
...
device = torch.device('cuda:0')  # Specify the appropriate GPU index
...
# Assuming you have imported necessary libraries and defined your model, optimizer, etc.
if __name__ == "__main__":
    for epoch in range(args.epochs):
        labels_list = []
        model.train()
        start = time.time()
        for j, (imgs) in enumerate(tqdm(train_batch)):  # Add tqdm to your loop
