...
parser.add_argument('--lambda1', type=float, default=0.6, help='weight for the anomality score')   
...
parser.add_argument('--dataset_path', type=str, default='D:\\DOCS\\Mtech_final_year_project\\codes\\LGN-Net\\LGN-Net\\avenue', help='directory of data')
parser.add_argument('--model_dir', type=str,  default='D:\\DOCS\\Mtech_final_year_project\\codes\\LGN-Net\\LGN-Net\\check\\10modelAv.pth',help='directory of model')
parser.add_argument('--m_items_dir', type=str, default='D:\\DOCS\\Mtech_final_year_project\\codes\\LGN-Net\\LGN-Net\\check\\10keysAv.pt',help='directory of model')
...
labels = np.load('D:\\DOCS\\Mtech_final_year_project\\codes\\LGN-Net\\LGN-Net\\labels\\frame_labels_'+args.dataset_type+'.npy')
...
for video in sorted(videos_list):
    ...
    anomaly_score_total_list += score_sum(anomaly_score_list(psnr_list[video_name]), 
                                    anomaly_score_list_inv(feature_distance_list[video_name]), args.lambda1)
