...
class lgn(torch.nn.Module):
    def __init__(self, n_channel ,  t_length , memory_size, feature_dim , key_dim , temp_update = 0.1, temp_gather=0.1):#n_channel =3,  t_length = 5, memory_size=10, feature_dim = 512, key_dim = 512, temp_update = 0.1, temp_gather=0.1
